...
urlpatterns = [
    ...
    url(r'^crearbanda/', views.formularioBanda.as_view(), name="formularioBanda"),
    url(r'^crearmusico/', views.formularioMusico.as_view(), name="formularioMusico"),
    url(r'^crearlocal/', views.formularioLocal.as_view(), name="formularioLocal"),
